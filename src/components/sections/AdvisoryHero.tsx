  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Subtle navy tint */}
        <div className="absolute inset-0" style={{ backgroundColor: 'rgba(26, 35, 50, 0.50)' }} />
            ...
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-16 items-end">
              <div>
                <p
                  ...
                  style={{ fontSize: '0.6rem', letterSpacing: '0.25em', color: 'var(--gold)', marginBottom: 'clamp(0.75rem, 1.5vw, 1.25rem)' }}
                >
                  | {t.advisory_page.label} |
                </p>
                <h1
                  className="font-serif"
                  style={{ fontSize: 'clamp(1.8rem, 3.5vw, 2.8rem)', fontWeight: 300, lineHeight: 1.08, letterSpacing: '-0.04em', color: 'white' }}
                >
              ...
              <p
                className="font-sans"
                style={{ fontSize: 'clamp(0.85rem, 1vw, 0.95rem)', lineHeight: 1.7, color: 'rgba(255,255,255,0.7)', maxWidth: '440px' }}
              >
