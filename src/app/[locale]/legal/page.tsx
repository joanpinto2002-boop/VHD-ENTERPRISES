...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return getPageMetadata('legal', locale as Locale);
}
...
export default async function LegalPage({
  ...
  const sections = [
    { title: t.legal_page.section1_title, text: t.legal_page.section1_text },
    { title: t.legal_page.section2_title, text: t.legal_page.section2_text },
    { title: t.legal_page.section3_title, text: t.legal_page.section3_text },
    { title: t.legal_page.section4_title, text: t.legal_page.section4_text },
    { title: t.legal_page.section5_title, text: t.legal_page.section5_text },
  ];
