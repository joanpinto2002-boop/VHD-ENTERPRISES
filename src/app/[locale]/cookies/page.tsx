...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return getPageMetadata('cookies', locale as Locale);
}
...
export default async function CookiesPage({
  ...
  const sections = [
    { title: t.cookies_page.section1_title, text: t.cookies_page.section1_text },
    { title: t.cookies_page.section2_title, text: t.cookies_page.section2_text },
    { title: t.cookies_page.section3_title, text: t.cookies_page.section3_text },
    { title: t.cookies_page.section4_title, text: t.cookies_page.section4_text },
  ];
